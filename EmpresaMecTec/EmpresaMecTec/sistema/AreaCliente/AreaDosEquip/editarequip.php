...
<body>
  <nav class="blue-grey lighten-1" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="../AreaCliente.php" class="brand-logo"><img src="backgrounds/logo.png" style="width:3em;"></a>
  ...
  <div class="container">
    <div class="section">
      ...
      <!--   Icon Section   -->
        <div class="row">
                <form class="col s12 z-depth-3" method="POST" action="editar.php">
                <?php
                        $idAlt = $_GET['id_user'];
                        $sql = " SELECT * FROM tb_equipamento WHERE id_cli = '$idAlt'; ";
                    ...
                    ?>
                        ...
                        <h5 class="center">Editar equipamento</h5>

                        <div class="input-field col s6">
                        <input placeholder="Insira o id" type="text" name="id_cli" readonly="true" value="<?php echo $row['id_cli'];?>">
                        <label>Id do Cliente</label>
                        </div>

                        <div class="input-field col s6">
                        <input placeholder="Insira seu nome de usuário" type="text" name="nome_user" readonly="true" value="<?php echo $row['nome'];?>">
                        <label>Nome:</label>
                        </div>

                        <div class="input-field col s6">
                        <input placeholder="Insira o nome ou a marca do equipamento" type="text" name="marca" value="<?php echo $row['marca'];?>">
                        <label>Nome / Marca:</label>
                        </div>

                        <div class="input-field col s6">
                        <input placeholder="Insira o modelo do equipamento" type="text" name="modelo" value="<?php echo $row['modelo'];?>">
                        <label>Modelo:</label>
                        </div>

                        <div class="input-field col s6">
                        <input placeholder="Insira a cor do produto" type="text" name="cor" value="<?php echo $row['cor'];?>">
                        <label>Cor:</label>
                        </div>

                        <div class="input-field col s6">
                        <input placeholder="Insira alguma informação sobre o produto (não obrigatório)" type="text" name="observacao" value="<?php echo $row['observacao'];?>">
                        ...
                        <button class="btn waves-effect indigo col s8 m12" type="submit" name="action" >Editar
