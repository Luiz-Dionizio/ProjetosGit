  ...
  <nav class="indigo darken-3" role="navigation">
    <div class="nav-wrapper container">
        <a id="logo-container" class="brand-logo"><img src="../../backgrounds/logoofc.png" style="width:3em;"></a>
          ...
          <a href="#" data-target="nav-mobile" class="sidenav-trigger"><i class="large material-icons indigo-text text-darken">menu</i></a>
        </div>
    </nav>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Área ordem de serviço</h5>
              <form method= "POST" action="AreaDasOS/AreaOS.php">
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Área Clientes</h5>
                <form method= "POST" action="AreaDosClientes/AreaClientes.php">
                  <button class="btn waves-effect indigo col s8 m12" type="submit" name="action">Entrar
                  <i class="material-icons right">send</i>
                  </button>
                </form>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center light-blue-text"><i class="large material-icons indigo-text text-darken">phone</i></h2>
            <h5 class="center">Área Relatórios</h5>
            <form method= "POST" action="AreaDosRelatorios/AreaRelatorios.php">
                <button class="btn waves-effect indigo col s8 m12" type="submit" name="action">Entrar
                <i class="material-icons right">send</i>
                </button>
            </form>
