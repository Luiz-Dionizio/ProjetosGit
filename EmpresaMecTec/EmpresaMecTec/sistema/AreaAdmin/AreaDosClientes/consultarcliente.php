      ...
      <div class="row">
        <div class="col s12 m5">
          ...
          <div class="icon-block z-depth-5">
            ...
            <h5 class="center">Consultar por nome</h5>
            ...
            <p class="light">
                <form method="POST">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM tb_user WHERE nome_user LIKE '$tx_pesq%';";
                    ...
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                <a href="alterarcliente.php?id_user=<?= $row['id_user'] ?>"> <i class="large material-icons indigo-text text-darken">create</i> </a>
                                </td>

                                <td>
                                <a onclick=" return confirm('Deseja realmente excluir?'); "
                                href="excluir.php?id_user=<?php echo $row['id_user']; ?>"> <i class="large material-icons indigo-text text-darken">delete</i> </a>
                                </td>
        ...
        <div class="col s12 m2">
          <div class="icon-block">
            ...
            <h5 class="center">Consultar Usuário</h5>
        ...
        <br><br><br>
          <div class="icon-block z-depth-5">
            <h2 class="center light-blue-text"><i class="material-icons"></i></h2>
            <h5 class="center">Pesquisar por código de usuário</h5>

            <p class="light" >
            <form method="POST">
                    <label>Pesquisar pelo id do usuário</label>
                    <input type="text" name="tx_pesquisa">
                    ...
                    <?php
                        $tx_pesq = isset($_POST['tx_pesquisa']) ? $_POST['tx_pesquisa'] : '';
                        $sql = "SELECT * FROM tb_user WHERE id_user LIKE '$tx_pesq%';";
                        $query = mysqli_query($conn, $sql);
                        if( $query ){
                            while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
                    ?>
