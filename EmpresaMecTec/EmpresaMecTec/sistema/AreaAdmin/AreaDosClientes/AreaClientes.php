      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center light-blue-text"><i class="large material-icons indigo-text text-darken" style="margin-top: 110px">person_add</i></h2>
            <h5 class="center" >Cadastrar Clientes</h5>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center light-blue-text"><i class="large material-icons indigo-text text-darken" style="margin-top: 110px">group</i></h2>
            <h5 class="center">Consultar Clientes</h5>
