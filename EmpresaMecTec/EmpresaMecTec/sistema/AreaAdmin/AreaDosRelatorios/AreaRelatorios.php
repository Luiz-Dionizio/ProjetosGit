    ...
    <div class="nav-wrapper container">
      <a id="logo-container" href="../AreaAdmin.php" class="brand-logo"><img src="../../../backgrounds/logoofc.png" style="width:3em;"></a>
          <ul class="right hide-on-med-and-down">
            <li><a href="../AreaAdmin.php">Voltar para Área Admin</a></li>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center light-blue-text"><i class="large material-icons indigo-text text-darken" style="margin-top: 110px">archive</i></h2>
            <h5 class="center" >Garantias</h5>
                <form method= "POST" action="areagarantias.php">
                  <button class="btn waves-effect indigo col s8 m12" type="submit" name="action">Entrar
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center light-blue-text"><i class="large material-icons indigo-text text-darken"></i></h2>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center light-blue-text"><i class="large material-icons indigo-text text-darken" style="margin-top: 110px">attach_money</i></h2>
            <h5 class="center">Orçamento</h5>

            <p class="light">
                <form method= "POST" action="areaorcamento.php">
                  <button class="btn waves-effect indigo col s8 m12" type="submit" name="action">Entrar
                  <i class="material-icons right">send</i>
                  </button>
                </form>
