      ...
      <div class="row">
        <div class="col s12 m5">
          ...
          <div class="icon-block z-depth-5">
            ...
            <h5 class="center">Consultar por pessoa</h5>
        ...
        <div class="col s12 m2">
          <div class="icon-block">
            ...
            <h5 class="center">Consultar Orçamentos</h5>
        ...
        <br><br><br>
          <div class="icon-block z-depth-5">
            <h2 class="center light-blue-text"><i class="material-icons"></i></h2>
            <h5 class="center">Consultar por código da OS</h5>
            ...
            <form method="POST">
                    ...
                    <?php
                        $tx_pesq = isset($_POST['tx_pesquisa']) ? $_POST['tx_pesquisa'] : '';
                        $sql = "SELECT * from tb_os inner join tb_user on(tb_os.id_user = tb_user.id_user) where tb_os.id_os LIKE '$tx_pesq%';";
                        $query = mysqli_query($conn, $sql);
                        if( $query ){
                            while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
                    ?>
